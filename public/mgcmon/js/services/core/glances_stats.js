glancesApp.service('GlancesStats', function($http, $injector, $q, GlancesPlugin) {
    ...
    this.getAllStats = function() {
        return $http.get('/monitor/api/all').then(function (response) {
    ...
    this.getAllLimits = function() {
        return $http.get('/monitor/api/all/limits').then(function (response) {
    ...
    this.getAllViews = function() {
        return $http.get('/monitor/api/all/views').then(function (response) {
    ...
    this.getHelp = function() {
        return $http.get('/monitor/api/help').then(function (response) {
            return response.data;
        });
    };
